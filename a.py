...
test_data['Family_lenth'] = test_data['SibSp'] + test_data['Parch']
test_data['Family_class'] =test_data['Pclass']*test_data['Family_lenth']


test_data = test_data[['Sex','Family_class','Family_lenth']]
...
test_data['Sex'] = pd.get_dummies(test_data['Sex']).values
...
with tf.Session() as sess:
    ...
    a = sess.run(tf.argmax(pred,1), feed_dict={X: test_data})
a = pd.DataFrame({'Survived':a})
a.to_csv('dataset/t.csv')
#    print pred,cost
